...
<main>
  ...
  <div class="container">
    <div class="Profile-side">
      ...
      <div class="sources">
        <a href="Project 1 Documentation.pdf" target="_blank" rel="noopener noreferrer">Click to view documentation</a>
      </div>
      <div class="sources">
        <a href="https://youtu.be/NE_xCZSGTF4" target="_blank" rel="noopener noreferrer">Click to view demo</a>
      </div>
      <div class="sources">
        <a href="https://github.com/21laraines/Media-Tracker5/tree/main" target="_blank" rel="noopener noreferrer">Click to view GitHub</a>
      </div>
    </div>
  </div>
